...
uses
  ...
  Filter_Parameters,show,delete,copy,Show_correct,FileInfo,test,  LazLogger,
  LazLoggerBase,s2p,track,ScreenShot;
...
type
  ...
  TfrmMain = class(TForm)
    MainMenu1: TMainMenu;
    MenuItem1: TMenuItem;
    nmuScreenShot: TMenuItem;
    mnuTracking: TMenuItem;
    mnuS2P: TMenuItem;
...
procedure TfrmMain.nmuScreenShotClick(Sender: TObject);
begin
     if frmScreenShot.ShowModal=mrOK then //Show the
          begin
...
procedure TfrmMain.mnuTrackingClick(Sender: TObject);
begin
 if   frmTrack.ShowModal=mrOK then   //Show the form
  begin
