...
DeleteFile(GetUserDir + 'Desktop' + PathDelim + 'Filter.s2p');//if file exist delete it
  if FileExists( GetUserDir + 'Desktop' + PathDelim +  'Test_coefficient.csv') then
DeleteFile(GetUserDir + 'Desktop' + PathDelim + 'Test_coefficient.csv');//if file exist delete it
